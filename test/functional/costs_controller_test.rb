...
class CostsControllerTest < ActionController::TestCase
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post :create, cost: { descripcion: @cost.descripcion, modificable: @cost.modificable, monto: @cost.monto, obligatorio: @cost.obligatorio, seguridad: @cost.seguridad, tipo: @cost.tipo }
    end
  ...
  test "should update cost" do
    put :update, id: @cost, cost: { descripcion: @cost.descripcion, modificable: @cost.modificable, monto: @cost.monto, obligatorio: @cost.obligatorio, seguridad: @cost.seguridad, tipo: @cost.tipo }
    assert_redirected_to cost_path(assigns(:cost))
  end
